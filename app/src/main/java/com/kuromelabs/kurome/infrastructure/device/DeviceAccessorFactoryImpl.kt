...
class DeviceAccessorFactoryImpl @Inject constructor(var identityProvider: IdentityProvider) :
    ...
    override fun create(link: Link, device: Device): DeviceAccessor {
        val accessor: DeviceAccessor = DeviceAccessorImpl(link, device, identityProvider, this)
